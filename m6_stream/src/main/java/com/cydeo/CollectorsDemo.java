...
public class CollectorsDemo {
    public static void main(String[] args) {
       ...
       List<Integer> numberList = numbers.stream()
        ...
        //summingInt (toIntFunction) : returns a Collector that produces the sun of a Integer- valued func
       ...
       //joining(): is used to join various elements of a character or string array into a single object
        ...
        //partitioningBy() : is used to partition a stream of objects( or a set of elements) based on given predicate.
